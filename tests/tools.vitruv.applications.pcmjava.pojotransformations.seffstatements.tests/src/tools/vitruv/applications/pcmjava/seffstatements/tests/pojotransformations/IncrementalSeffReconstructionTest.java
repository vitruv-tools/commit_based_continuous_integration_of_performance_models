...
public class IncrementalSeffReconstructionTest extends Java2PcmTransformationTest {
    ...
    protected List<ChangePropagationSpecification> createChangePropagationSpecifications() {
    	return Collections.singletonList(new Java2PcmWithSeffstatmantsChangePropagationSpecification());
    }
