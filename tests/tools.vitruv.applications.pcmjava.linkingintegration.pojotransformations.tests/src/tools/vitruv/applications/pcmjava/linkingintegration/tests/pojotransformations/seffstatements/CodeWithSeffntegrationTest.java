...
public class CodeWithSeffntegrationTest extends CodeIntegrationTest implements SynchronizationAwaitCallback {
    ...
    protected String getTestProjectName() {
        return CodeWithSeffntegrationTest.TEST_PROJECT_NAME_JSCIENCE;
    }

    @Override
    protected String getTestBundleName() {
        return CodeWithSeffntegrationTest.TEST_BUNDLE_NAME_JSCIENCE;
    }

    @Override
    protected String getTestSourceAndModelFolder() {
        return CodeWithSeffntegrationTest.SRC_AND_MODEL_FOLDER_JSCIENCE;
    }
