...
public abstract class AbstractInstrumenter {
     ...
     * 
     * @param aip
     *            provides the AbstractAction for the instrumentation.
     * @param statementMapping
     *            a mapping to retrieve the corresponding statements of the AbstractAction.
     */
