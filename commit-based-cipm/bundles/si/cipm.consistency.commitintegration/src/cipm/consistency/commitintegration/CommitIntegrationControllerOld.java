 ...
 * @author Lukas Burgey
 */
public abstract class CommitIntegrationControllerOld<CM extends CodeModelFacade> {
    private static final Logger LOGGER = Logger.getLogger(CommitIntegrationControllerOld.class.getName());
