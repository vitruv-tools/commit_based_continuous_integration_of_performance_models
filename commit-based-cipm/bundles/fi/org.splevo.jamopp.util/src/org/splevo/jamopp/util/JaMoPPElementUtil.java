...
public final class JaMoPPElementUtil {
	...
	/**
	 * Determines a qualified name for the given element. The name is not fully
	 * qualified but gives some hints about the location of the element. The
	 * compilation unit and the containing classifier and method are mentioned.
	 * 
	...
	/**
	 * Determines the qualified name of a given EObject. If the object is no
	 * Commentable, null will be returned.
	 */
