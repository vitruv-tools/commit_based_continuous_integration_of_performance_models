...
public class FieldCreatedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.FieldCreatedReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.FieldCreatedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final org.emftext.language.java.classifiers.Class affectedEObject, final EReference affectedFeature, final Field newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      ...
      final Classifier type = JavaTypeUtil.getNormalizedClassifierFromTypeReference(newValue.getTypeReference());
      ...
      _routinesFacade.createOrFindAssemblyContext(newValue.getContainingConcreteClassifier(), newValue);
    }
  }
}
