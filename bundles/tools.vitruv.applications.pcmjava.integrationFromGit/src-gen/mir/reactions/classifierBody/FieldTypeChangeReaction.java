...
public class FieldTypeChangeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<Field, TypeReference> replaceChange;
  
  private int currentlyMatchedChange;
  
  public FieldTypeChangeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.classifierBody.FieldTypeChangeReaction.ActionUserExecution userExecution = new mir.reactions.classifierBody.FieldTypeChangeReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEReference replaceChange, final Field affectedEObject, final EReference affectedFeature, final TypeReference oldValue, final TypeReference newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changeInnerDeclarationType(newValue, affectedEObject);
    }
  }
}
