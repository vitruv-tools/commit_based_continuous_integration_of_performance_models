...
public class InterfaceCreatedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegrationExtended.InterfaceCreatedReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegrationExtended.InterfaceCreatedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final CompilationUnit affectedEObject, final EReference affectedFeature, final Interface newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.createOrFindPCMInterface(newValue, affectedEObject);
    }
  }
}
