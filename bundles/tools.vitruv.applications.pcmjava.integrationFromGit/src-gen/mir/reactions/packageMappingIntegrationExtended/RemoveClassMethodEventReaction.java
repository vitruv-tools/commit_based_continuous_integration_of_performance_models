...
public class RemoveClassMethodEventReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegrationExtended.RemoveClassMethodEventReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegrationExtended.RemoveClassMethodEventReaction.ActionUserExecution(this.executionState, this);
