...
public class RemoveImportReactionReaction extends AbstractReactionRealization {
  ...
  public RemoveImportReactionReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegrationExtended.RemoveImportReactionReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegrationExtended.RemoveImportReactionReaction.ActionUserExecution(this.executionState, this);
