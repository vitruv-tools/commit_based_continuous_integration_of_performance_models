...
public class TypeReferenceRemovedReaction extends AbstractReactionRealization {
  private RemoveEReference<org.emftext.language.java.classifiers.Class, TypeReference> removeChange;
  
  private int currentlyMatchedChange;
  
  public TypeReferenceRemovedReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageAndClassifiers.TypeReferenceRemovedReaction.ActionUserExecution userExecution = new mir.reactions.packageAndClassifiers.TypeReferenceRemovedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final org.emftext.language.java.classifiers.Class affectedEObject, final EReference affectedFeature, final TypeReference oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.removeOperationProvidedRole(oldValue);
    }
  }
}
