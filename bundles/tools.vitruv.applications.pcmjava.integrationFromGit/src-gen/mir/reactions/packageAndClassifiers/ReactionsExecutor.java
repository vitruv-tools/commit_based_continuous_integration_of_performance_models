...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(new mir.reactions.packageAndClassifiers.AddClassAnnotationReactionReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("packageAndClassifiers"))));
    this.addReaction(new mir.reactions.packageAndClassifiers.RemoveClassAnnotationReactionReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("packageAndClassifiers"))));
