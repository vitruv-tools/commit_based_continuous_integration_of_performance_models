...
public class CreateJavaPackageRoutine extends AbstractRepairRoutineRealization {
  ...
  public CreateJavaPackageRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject sourceElementMappedToPackage, final org.emftext.language.java.containers.Package parentPackage, final String packageName, final String newTag) {
    ...
    this.userExecution = new mir.routines.packageMappingIntegrationExtended.CreateJavaPackageRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    addCorrespondenceBetween(userExecution.getElement1(sourceElementMappedToPackage, parentPackage, packageName, newTag, javaPackage), userExecution.getElement2(sourceElementMappedToPackage, parentPackage, packageName, newTag, javaPackage), "");
    
    addCorrespondenceBetween(userExecution.getElement3(sourceElementMappedToPackage, parentPackage, packageName, newTag, javaPackage), userExecution.getElement4(sourceElementMappedToPackage, parentPackage, packageName, newTag, javaPackage), userExecution.getTag1(sourceElementMappedToPackage, parentPackage, packageName, newTag, javaPackage));
