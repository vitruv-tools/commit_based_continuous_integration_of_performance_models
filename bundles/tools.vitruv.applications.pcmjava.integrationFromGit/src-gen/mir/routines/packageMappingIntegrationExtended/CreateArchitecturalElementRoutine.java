...
public class CreateArchitecturalElementRoutine extends AbstractRepairRoutineRealization {
    ...
    public void callRoutine1(final org.emftext.language.java.containers.Package javaPackage, final String name, final String rootPackageName, @Extension final RoutinesFacade _routinesFacade) {
      ...
      if (!_matched) {
        ...
        if (Objects.equal(selected, _selection_2)) {
          _matched=true;
          _routinesFacade.createOrFindSystem(javaPackage, name);
        }
      }
    }
  }
  ...
  public CreateArchitecturalElementRoutine(final RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final org.emftext.language.java.containers.Package javaPackage, final String name, final String rootPackageName) {
    ...
    this.userExecution = new mir.routines.packageMappingIntegrationExtended.CreateArchitecturalElementRoutine.ActionUserExecution(getExecutionState(), this);
