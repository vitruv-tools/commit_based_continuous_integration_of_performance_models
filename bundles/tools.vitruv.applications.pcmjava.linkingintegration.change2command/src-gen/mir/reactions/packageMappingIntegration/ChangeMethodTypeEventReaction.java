...
public class ChangeMethodTypeEventReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<Method, TypeReference> replaceChange;
  
  private int currentlyMatchedChange;
  
  public ChangeMethodTypeEventReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegration.ChangeMethodTypeEventReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegration.ChangeMethodTypeEventReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEReference replaceChange, final Method affectedEObject, final EReference affectedFeature, final TypeReference oldValue, final TypeReference newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.changedMethodType(affectedEObject, newValue);
    }
  }
}
