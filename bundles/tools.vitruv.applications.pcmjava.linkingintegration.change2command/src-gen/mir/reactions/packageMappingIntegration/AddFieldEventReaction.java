...
public class AddFieldEventReaction extends AbstractReactionRealization {
  ...
  public AddFieldEventReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegration.AddFieldEventReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegration.AddFieldEventReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final ConcreteClassifier affectedEObject, final EReference affectedFeature, final Member newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.addedFieldEvent(affectedEObject, ((Field) newValue));
    }
  }
}
