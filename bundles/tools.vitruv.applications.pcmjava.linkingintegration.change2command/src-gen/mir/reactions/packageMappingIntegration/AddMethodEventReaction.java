...
public class AddMethodEventReaction extends AbstractReactionRealization {
  ...
  public AddMethodEventReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegration.AddMethodEventReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegration.AddMethodEventReaction.ActionUserExecution(this.executionState, this);
