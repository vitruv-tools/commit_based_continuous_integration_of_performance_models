...
public class MethodParameterNameChangeEventReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Parameter, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public MethodParameterNameChangeEventReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.packageMappingIntegration.MethodParameterNameChangeEventReaction.ActionUserExecution userExecution = new mir.reactions.packageMappingIntegration.MethodParameterNameChangeEventReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.methodParameterNameChangedEvent(affectedEObject, oldValue, newValue);
    }
  }
}
