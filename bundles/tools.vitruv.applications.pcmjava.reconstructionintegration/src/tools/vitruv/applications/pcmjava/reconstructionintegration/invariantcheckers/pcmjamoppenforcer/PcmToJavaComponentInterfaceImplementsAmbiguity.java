 ...
 *
 */
public class PcmToJavaComponentInterfaceImplementsAmbiguity extends PcmRepositorytoJavaInvariantEnforcer {
     ...
     */
    public PcmToJavaComponentInterfaceImplementsAmbiguity() {
