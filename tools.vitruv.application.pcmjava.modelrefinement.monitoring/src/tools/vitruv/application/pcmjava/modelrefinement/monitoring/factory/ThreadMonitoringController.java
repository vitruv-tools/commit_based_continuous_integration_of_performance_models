...
import tools.vitruv.application.pcmjava.modelrefinement.adaptive.monitoring.ProbesActiveness;
import tools.vitruv.application.pcmjava.modelrefinement.adaptive.monitoring.ProbesActivenessImp;
...
public class ThreadMonitoringController {
	...
	private static class ServiceMonitoringController {
        ...
        private ProbesActiveness probesActivess;
        ...
        public void enterService(
            ...
            this.probesActivess = new ProbesActivenessImp();
        }
        ...
        public void exitService() {
            ...
            if (this.probesActivess.isProbeActivated(serviceId))
        ...
        public void logBranchExecution(final String branchId, final String executedBranchId) {
            ...
            if (this.probesActivess.isProbeActivated(branchId))
        ...
        public void logLoopIterationCount(final String loopId, final long loopIterationCount) {
            ...
            if (this.probesActivess.isProbeActivated(loopId))
                MONITORING_CONTROLLER.newMonitoringRecord(record);
        }
        ...
        public void logResponseTime(final String internalActionId, final String resourceId, final long startTime) {
            ...
            if (this.probesActivess.isProbeActivated(internalActionId)) {
            	if(isResponseTimeValid(currentTime, startTime)) {
                	MONITORING_CONTROLLER.newMonitoringRecord(record);
            	}
            }
